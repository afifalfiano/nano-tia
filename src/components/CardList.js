      ...
      <div className="row g-0">
        ...
        <div className="col-md-8">
          <div className="card-body">
            <h5 className="card-title d-inline-block me-2">{post?.title}</h5><span><small className="text-muted">{post.read_time} min read </small></span>
            <div className="card-text m-0 text-secondary">
              ...
              Author by {post?.author?.display_name}</div>
